...
namespace Backend
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Backend.Customer roland = new Backend.Customer("Roland", 69, "Somewhere in Toronto", new Backend.AccountDetails("3232", new Backend.Card("Chequing", 123, 123, 123, 10), null));
